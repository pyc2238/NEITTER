...
<br>
    <div class="row">
        ...
        <h4 style='color:blue;font-family: "Nanum Gothic", sans-serif;'><b>프로젝트 개요</b></h4>
            ...
            <p>NEITTER는 2018년 10월 2일 처음 개발되기 시작한 한일 펜팔사이트로 한일간의 개개인의 문화적 교류를 통하여 정치적,역사적문제로 얽힌 한일관계의 어려움에 있어 민간
            ...
            <p>"잠옷차림으로 옆집 친구와 컴퓨터를 마주놓고 채팅을 하듯 편지를쓰듯.."이러한 개개인의 문화교류가 NEITTER가 추구하는 교류입니다.</p>

            <p>NEITTER은 인터넷상에서 발생하는 모든 한일간 민간교류를 지원합니다. 아울러 한국, 일본내의 오프라인 모임을 통하여 정보교환 및 어학적관심사를 가진 회원간의 어학 모임등을 지원하고 육성시킵니다.</p>
        </div>
        
        <div class="w-100"></div>
        <div class="col" style='margin-top:40px'>
        <h4 style='color:blue;font-family: "Nanum Gothic", sans-serif;'><b>구현현황</b></h4>
            <br>
            <ul style='margin-left:35px'>
                ...
                <li><b>Laravel 프레임 워크 전환</b></li>
                    ...
                    <b style='color:red'>-2018년11월 25일 ~ 12월3일 현재 구현된 코드 대폭 수정</b><br>
            </ul>
        </div>
    </div>
</div>
