...
<div class="row changePw_form" >
    ...
    <form action="{{route('updatePassword',Auth::user()->id)}}" method="post">
            ...
            <input type="password" id="inputPassword" name="password" class="form-control" autocomplete=off required>
            <label for="inputPassword">새 비밀번호</label>
            <input type="password" id="inputPassword" name="new_password" class="form-control" autocomplete=off required>
