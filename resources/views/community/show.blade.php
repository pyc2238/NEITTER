...
<div class="container content">
    <div class="col">
        ...
        <div class="col text-center" style="margin-top:40%;border:1px solid">
            ...
            <form style="display:inline-block" action="{{route('community.destroy',['boardNum'=>$community->num,'search'=>$search,'where'=>$where,'page'=>$page])}}"
                method="post">
                @csrf
                @method('delete')
