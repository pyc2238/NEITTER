<style>
    ...
    <!-- profile Modal -->
    <div class="modal fade" id="Modal-large-demo{{ $sender->user->id }}" tabindex="-1" role="dialog" aria-labelledby="Modal-large-demo-label"
    aria-hidden="true">
                    ...
                    <div class="col-7" >
                        ...
                        <table class="table scrolltbody">
                            <tr>
                                ...
                                <td><b style="color:blue">{{ $sender->user->name }}<b></td>
                            </tr>
                            <tr>
                                <th>@lang('auth/profile.model_age')</th>
                                <td><b style="color:blue">{{ $sender->user->age }}<b></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><b style="color:blue">{{ $sender->user->address}}<b></td>
                            </tr>
                            <tr>
                                <th>@lang('auth/profile.model_Date_of_entry')</th>
                                <td><b style="color:blue">{{ $sender->user->created_at }}<b></td>
                            </tr>
                            
                            <tr>
                                <th>@lang('auth/profile.model_self_introduction')</th>
                                <td><b style="color:blue">{{ $sender->user->selfContext }}<b></td>
                            </tr>
                        </table>
                    </div>
                </div>
